...
//
//
//class MainActivityCopy : AppCompatActivity(), SurfaceHolder.Callback {
//
...
//        if (rtmpUSB.prepareVideo(width, height, 60, 4000 * 1024, 0, uvcCamera) && rtmpUSB.prepareAudio()) {
...
//            runOnUiThread {
//                Toast.makeText(this@MainActivityCopy, "onAuthSuccessRtmp", Toast.LENGTH_SHORT).show()
//            }
//        }
//
//        override fun onConnectionSuccessRtmp() {
//            runOnUiThread {
//                Toast.makeText(this@MainActivityCopy, "Success", Toast.LENGTH_SHORT).show()
//            }
//        }
//
//        override fun onConnectionFailedRtmp(reason: String) {
//            runOnUiThread {
//                Toast.makeText(this@MainActivityCopy, "Failed $reason", Toast.LENGTH_SHORT).show()
//                rtmpUSB.stopStream(uvcCamera)
//            }
//        }
//
...
//            runOnUiThread {
//                Toast.makeText(this@MainActivityCopy, "onAuthErrorRtmp", Toast.LENGTH_SHORT).show()
//            }
//        }
//
//        override fun onDisconnectRtmp() {
//            runOnUiThread {
//                Toast.makeText(this@MainActivityCopy, "Disconnect", Toast.LENGTH_SHORT).show()
//            }
//        }
//    }
//
